...
class TestBasicOps:
    def test_union(self, test_case):
        df_a = intervals_from_str(test_case["a"]).ivl()
        df_b = intervals_from_str(test_case["b"]).ivl()
        df_expected = intervals_from_str(test_case["a_union_b"]).ivl()
    ...
    def test_intersection(self, test_case):
        ...
        df_b = intervals_from_str(test_case["b"]).ivl()
        df_expected = (
            intervals_from_str(test_case["a_intersection_b"]).ivl()
        )
    ...
    def test_overlap(self, test_case):
        ...
        df_b = intervals_from_str(test_case["b"]).ivl()
        df_expected_a = (
            intervals_from_str(test_case["overlap_a"]).ivl()
        )
        df_expected_b = (
            intervals_from_str(test_case["overlap_b"]).ivl()
        )
    ...
    def test_non_overlap(self, test_case):
        ...
        df_b = intervals_from_str(test_case["b"]).ivl()
        df_expected_a = (
            intervals_from_str(test_case["non_overlap_a"]).ivl()
        )
        df_expected_b = (
            intervals_from_str(test_case["non_overlap_b"]).ivl()
        )
    ...
    def test_combine(self, test_case):
        ...
        df_expected_combine_a = (
            intervals_from_str(test_case["combine_a"]).ivl()
        )
        df_expected_combine_b = (
            intervals_from_str(test_case["combine_b"]).ivl()
        )
        df_expected_combine_a_union_b = (
            intervals_from_str(test_case["combine_a_union_b"]).ivl()
        )
    ...
    def test_complement(self, test_case):
        ...
        df_b = intervals_from_str(test_case["b"]).ivl()
        df_expected_a = (
            intervals_from_str(test_case["complement_a"]).ivl()
        )
        df_expected_b = (
            intervals_from_str(test_case["complement_b"]).ivl()
        )
    ...
    def test_diff(self, test_case):
        ...
        df_expected_a_diff_b = (
            intervals_from_str(test_case["a_diff_b"]).ivl()
        )
        df_expected_b_diff_a = (
            intervals_from_str(test_case["b_diff_a"]).ivl()
        )
